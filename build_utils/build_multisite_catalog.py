...
<meta name="forecast-hydro-page" content="{PAGE_MARKER}"><title>Jaringan Site, Forecast Hydro</title>
...
</style></head><body><div id="map" aria-label="Globe jaringan site Forecast Hydro"></div><div class="top"><a class="brand" href="index.html"><span class="mark">FR</span><span><b>Forecast Hydro Network</b><small>Multi-site intelligence</small></span></a><a class="home" href="index.html">Kembali ke portal</a></div>
<aside class="panel"><div class="eyebrow">Portfolio view</div><h1>Satu globe, seluruh site.</h1><p class="intro">Site yang telah diverifikasi dan site provisional ditampilkan bersama, tetapi status datanya tidak disamakan.</p><div class="sites">{cards}</div></aside>
...
def patch_homepage(outputs: Path) -> None:
    ...
    link = '<a id="fr-sites-entry" href="site_network.html">Semua Site, Globe Jaringan</a>'
